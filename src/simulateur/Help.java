...
public class Help {
 public Help(){
  ...
  System.out.println("java Simulateur.sh [...]");
  System.out.println();
  System.out.println("DESCRIPTION");
  System.out.println("Il s'agit de simuler la transmission d'un message numerique (train de bit 0 ou 1) dans un système de transmission entre un point d’entree jusqu'a un point de sortie, via un canal de transmission (ou de communication).Les nombreux paramètres de la simulation permettent de choisir les caracteristiques du message a transmettre, du canal de propagation et du système de transmission.");
  ...
  System.out.println("Par defaut le simulateur doit utiliser une chaîne de transmission logique, avec un message aleatoire de longueur 100, sans utilisation de sondes et sans utilisation de transducteurs.");
  System.out.println();
  ...
  System.out.println("Utilisation d’une transmission analogique : ne precise le nombre d’echantillons par bit et doit être une valeur entière positive. Par defaut, le simulateur doit utiliser 30 echantillons par bit.");
  System.out.println();
  ...
  System.out.println("Precise l’utilisation de mecanismes de determination, dans les etages de reception du signal analogique, des amplitudes min et max, des retards et de leurs amplitudes relatives. Par defaut, le simulateur n’utilise pas ces mecanismes, les valeurs des amplitudes min et max. s retards et de leurs amplitudes relatives sont des paramètres des etages de reception. ");
  System.out.println();
  System.out.println("-h -help");
  System.out.println("Permet d'afficher ce message d'aide");
  System.out.println();
  System.out.println("-testTEB");
  System.out.println("Permet d'enregistrer les résultats de la simulation");
  System.out.println("-testBruit");
  System.out.println("Permet de generer un fichier .Csv qui contient les echantillons du bruit generes par le simulateur. Il ne fonctionne que lorsque la transmission est bruitee");
