...
public class SimulateurTestTP4 {
	...
	*/
	...
	public void TestNRZMultiTrajetBruite() throws Exception{
		...
		System.out.println("	Chaine transmission analogique Multi Trajet et bruitee:");
		
				
		// Avec message predefini puis codage NRZ
		String options2[] = {"-mess","0101010101010101111111","-form","NRZ", "- snr 0", "-ti 1 3 0.9"};
		...
		String options3[] = {"-mess","0101001010101010101111111","-form","NRZ","-s", "- snr 0", "-ti 1 3 0.9"};
