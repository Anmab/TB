...
public class EmetteurNrzt extends Transmetteur<Boolean, Float> {
	...
	/**
	 * Construction d'un symbole en fonction des élements reçus Si True :
	 * (coef)*j+ampMin entre 0 et nbEch/3 ampMax entre nbEch/3 et (2*nbEch)/3
