...
public class EmetteurRzV2 extends Transmetteur<Boolean, Float> {
	private int nbEch;
	...
	public EmetteurRzV2(int nbEch, float ampMin, float ampMax) {
		super();
		this.nbEch = nbEch;
		this.ampMin = ampMin;
		this.ampMax = ampMax;
	...
	/**
	 * Construction d'un symbole en fonction des élements reçus Si True : ampMin
	 * entre 0 et nbEch/3 ampMax entre nbEch/3 et nbEch*2/3 ampMin entre
	 * nbEch*2/3 et nbEch
	 * 
	 * Si False : ampMin
	 * 
